      ...
      <tbody>
        ...
        <tr :class="{ 'event-active' : progress }">
          ...
          <td>
            ...
            <code>totaluploadprogress, totalBytes, totalBytesSent</code>)
          </td>
          <td>
